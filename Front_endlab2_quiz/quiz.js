...
let q1 = new Question('Who was get the first Nobel Prize in Asia');
let q2 = new Question('Which language is used for styling web pages?');
let q3 = new Question('Which is the national animal of India');
let q4 = new Question('Which is used for Connect To Database?');
let q5 = new Question('What is the full form of ISRO');

let a1 = new Answers('Rabindranath Thakur');
let a2 = new Answers('CSS');
let a3 = new Answers('Tiger');
let a4 = new Answers('PHP');
let a5 = new Answers('Indian Space Research Organization');
